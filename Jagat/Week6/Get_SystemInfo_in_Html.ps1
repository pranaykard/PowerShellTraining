...
"@
        ...
        foreach ($computer in $computername) {
            ...
            if ($everything_ok) {
                ...
                $html_os = Get-InfoOS -ComputerName $computer | ConvertTo-EnhancedHTMLFragment @params

                $params = @{'As' = 'List';
                    'PreContent' = '<h2>Computer System</h2>'
                }

                $html_cs = Get-InfoCompSystem -ComputerName $computer | ConvertTo-EnhancedHTMLFragment @params
                ...
                $html_dr = Get-InfoDisk -ComputerName $computer | ConvertTo-EnhancedHTMLFragment @params
                ...
                $html_pr = Get-InfoProc -ComputerName $computer | ConvertTo-EnhancedHTMLFragment @params 
                ...
                $html_na = Get-InfoNIC -ComputerName $Computer | ConvertTo-EnhancedHTMLFragment @params
